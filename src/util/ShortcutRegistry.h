...
inline const std::array<ShortcutDefinition, 19>& getShortcutDefinitions() {
  static const std::array<ShortcutDefinition, 19> definitions = {
      ...
      ShortcutDefinition{ShortcutId::GymTracker, StrId::STR_GYM_TRACKER, StrId::STR_GYM_TRACKER_APP_DESC, UIIcon::Trophy,
                         &CrossPointSettings::gymTrackerShortcut, &CrossPointSettings::gymTrackerShortcutOrder,
                         &CrossPointSettings::gymTrackerShortcutVisible},
  };
